// Function index to function name mapping based on UESP Function Indices
// This maps the most common function indices used in perk conditions
export const CTDA_FUNCTION_INDICES: Record<number, string> = {
  0: 'GetWantBlocking',
  1: 'GetDistance',
  2: 'AddItem',
  3: 'SetEssential',
